...
for i in 1
    do
    for valuesize in 8 16 64 256 
    do
        outdir="${data_prefix}/data/ex5/Meto_$valuesize.txt"
        ...
        echo "size: "$valuesize"" 
        rm -f $dir
        sed -i '22d' ./src/variable2.cpp
        sed -i '22i #define VALUE_LENGTH '$valuesize'' ./src/variable2.cpp
